...
export const action: ActionFunction = async ({ request }) => {
  ...
  if (!nin) fieldErrors.nin = "Fødselsnummer er påkrevd.";
    ...
    fieldErrors.nin = "Fødselsnummer må være 11 siffer langt.";
  ...
  if (!mobile) fieldErrors.mobile = "Mobilnummer er påkrevd.";
    ...
    fieldErrors.mobile = "Mobilnummer må være minst 8 siffer langt.";

  if (Object.keys(fieldErrors).length) {
    return json<ActionData>(
      { fieldErrors, fields: { nin, firstName, lastName, mail, mobile } },
      { status: 400 }
    );
  }
